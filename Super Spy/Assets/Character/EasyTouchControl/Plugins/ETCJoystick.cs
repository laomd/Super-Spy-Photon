...
public class ETCJoystick : ETCBase,IPointerEnterHandler,IDragHandler, IBeginDragHandler, IPointerDownHandler, IPointerUpHandler {
	...
	public float tmSpeed {
		get {
			return (cameraLookAt.gameObject.PropertyComponent() as HeroProperty).speed;
		}
		set {
			(cameraLookAt.gameObject.PropertyComponent() as HeroProperty).speed = (int)Mathf.Round(value);
		}
	}
